...
movies.forEach(video => {
    const videoElement = `
        <div class="col-md-4">
            <a href="${video.link}" target="_blank">
                <img src="${video.img}" alt="${video.title}" class="img-fluid">
                <p>${video.title}</p>
            </a>
        </div>
    `;
    ...
    switch (video.category) {
        case 'growcast':
            document.getElementById('growcast-videos').insertAdjacentHTML('beforeend', videoElement);
            break;
        case 'webinar':
            document.getElementById('webinar-videos').insertAdjacentHTML('beforeend', videoElement);
            break;
        case 'ux-ui':
            document.getElementById('ux-ui-videos').insertAdjacentHTML('beforeend', videoElement);
            break;
        case 'geral':
            document.getElementById('diversos-videos').insertAdjacentHTML('beforeend', videoElement);
            break;
        default:
            break;
    }
